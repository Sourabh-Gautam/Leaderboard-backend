...
import com.epam.leaderboard.service.SkillsService;
...
public class SkillsController {
	...
	private static final Logger LOGGER = LogManager.getLogger(SkillsController.class);
	 ...
	 */
	@GetMapping("/Skills")
	public ResponseEntity<List<SkillsDTO>> getSkills() throws EntityNotFoundException {
